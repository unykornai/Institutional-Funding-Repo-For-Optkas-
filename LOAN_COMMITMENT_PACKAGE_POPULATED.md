...
## SECTION 1: CONDITIONAL COMMITMENT REQUIREMENTS

### 1.1 Borrower Information (Pre-Filled)
...
## SECTION 3: SBLC COLLATERAL (If Required by Lender)

### 3.1 SBLC Structure

If lender requires SBLC as additional or primary collateral:

| Parameter | Response |
|:----------|:---------|
| **SBLC Amount** | Equal to loan amount requested |
| **Issuing Bank** | [To be designated by Borrower] |
| **Beneficiary** | Per Facility Agreement |
| **Format** | MT760 (operative) via MT799 (pre-advice) |
| **Expiry** | Facility maturity + 30 days |
| **Characteristics** | Irrevocable, unconditional, freely transferable, cash-backed |

### 3.2 SBLC Authentication Process
...
- [ ] Valid for full facility term plus 30-day buffer
- [ ] Drawable upon simple written demand (no litigation required)

---

## SECTION 4: DUE DILIGENCE DOCUMENTS

### 4.0 Chain of Custody Statement

> **"Original collateral documents were physically delivered via tracked courier (FedEx) on January 22, 2026, received, scanned, and catalogued. Chain of custody is complete and verifiable via third-party carrier records. Originals remain available upon lender request."**
...
**Lender does not need to trust Borrower reporting.**
...
| # | Condition | Status |
|:--|:----------|:-------|
| 1 | Term Sheet / Commitment Letter | ⏳ Awaiting lender |
| 2 | Wire Instructions | ⏳ Awaiting lender |
| 3 | Lender's Counsel Comments | ⏳ Awaiting lender |

---

## SECTION 8: ATTACHED DOCUMENTS INDEX
...
**Request access:** jimmy@optkas.com  
**Format:** View-only Google Drive or OneDrive  
**Contents:** All documents listed in Section 8
